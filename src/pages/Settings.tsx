                    ...
                    <ul className=''>
                        <li>
                            ...
                            <div className="w-full md:w-1/2">
                                <input className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-username" type="text" placeholder="Novo nome de usuário"/>
                            </div>
                        </li>
                        <li className='mt-8 mb-3'>
                            <p>Alterar foto de perfil</p>
                            <div className="flex justify-between">
                                <div className="w-1/4 bg-blue-200 rounded-md shadow-md border-2 border-transparent hover:border-lightGreen cursor-pointer h-32">
                                    
                                </div>
                                <div className="w-1/4 bg-red-200 rounded-md shadow-md border-2 border-transparent hover:border-lightGreen cursor-pointer h-32">
                                   
                                </div>
                                <div className="w-1/4 bg-yellow-200 rounded-md shadow-md border-2 border-transparent hover:border-lightGreen cursor-pointer h-32">
                                    
                                </div>
                                <div className="w-1/4 bg-green-200 rounded-md shadow-md border-2 border-transparent hover:border-lightGreen cursor-pointer h-32">
        ...
        case 'Notificações':
            return (
                <div className='text-mainFontColor font-montserrat'>
                    <div>
                        ...
                        <label htmlFor="ativarNotificacoes"> Ativar notificações push</label>
                    </div>

                    <div className='pt-5'>
                        <input type="checkbox" id="ativarNotificacoes" />
                        <label htmlFor="ativarNotificacoes"> Ativar notificações por email</label>
                    </div>
                </div>
            );
            ...
            case 'Privacidade e segurança':
                return (
                    <div className='text-mainFontColor font-montserrat '>
                        <ul className=''>
                            <li><p className='mt-8 mb-3 '>
                                Alterar email</p>
                                <div className="w-full md:w-1/2 ">
                                    <input className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-email" type="email" placeholder="Novo email"/>
                                </div>
                            </li>
                            <li><p className='mt-8 mb-3'>
                                Alterar senha</p>
                                <div className=" w-full md:w-1/2 ">
                                    <input className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-senha" type="password" placeholder="Nova senha"/>
                                </div>
                            </li>
                        </ul>
                    </div>
  ...
  return (
    <div className="flex">
      ...
      <div className='bg-mainBg flex-initial w-full min-h-screen '>
        ...
        <div className="w- md:w-80"> 
            <ul className="options text-darkGreen font-montserrat font-medium px-12 py-3 m-10 ml-20 bg-bgAside rounded-lg border-none">
              <li
          ...
          <div className="flex-1 ml-10">
            ...
            {showButtons && (
              <div className="flex justify-end mt-6">
                <button onClick={() => setShowConfirmModal(true)} className="transition ease-in-out delay-150 bg-darkGreen hover:-translate-y-1 hover:scale-110 hover:bg-lightGreen duration-300 p-3 rounded-lg m-5">
                  Salvar mudanças
                </button>
