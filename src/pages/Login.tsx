                                    ...
                                    <form onSubmit={registerLogic} className='flex gap-3 w-11/12 mt-5'>
                                        <div className="w-full flex flex-col gap-3" id="firstSignup">
                                            <div>
                                                ...
                                                <input className='w-full h-10 rounded-sm outline-none pl-3' type="text" value={username} onChange={(e) => setUsername(e.target.value)} />
                                            </div>
                                            <div>
                                                <p className='text-bgWathcList'>Email:</p>
                                                <input className='w-full h-10 rounded-sm outline-none pl-3' type="text"  value={email} onChange={(e) => setEmail(e.target.value)}/>
                                            </div>
                                            <div>
                                                <p className='text-bgWathcList'>Senha:</p>
                                                <input className='w-full h-10 rounded-sm outline-none pl-3' type="password" value={password}                 onChange={(e) => setPassword(e.target.value)}/>
                                            </div>
                                            <div>
                                                <p className='text-bgWathcList'>Confirme a senha:</p>
                                                <input className='w-full h-10 rounded-sm outline-none pl-3' type="password" value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)}/>
                                            </div>
                                        ...
                                        <div id="nextSignup" className="hidden flex-col gap-3 w-full">
                                            <div>
                                                ...
                                                <input className='w-full h-10 rounded-sm outline-none px-3' type="date" id="dateOfBirth"  value={dob}           onChange={(e) => setDob(e.target.value)}/>
                                            </div>
                                            <div>
