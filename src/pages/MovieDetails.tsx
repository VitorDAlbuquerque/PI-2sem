              ...
              {authContext.user?
                favorites.length>0?
                  favorites.filter((favorite)=> favorite.user.id == authContext.user?.id).length > 0?
                    <p key={`${authContext.user.id}`} onClick={addFavorite} className="text-constrastColor cursor-pointer hover:text-constrastColor transition-all duration-200">
                      <FaStar/>
                    </p>
                  :
                    <p key={`${movieId}`} onClick={addFavorite} className="text-gray-500 cursor-pointer hover:text-constrastColor transition-all duration-200">
                      <FaRegStar/>
                    </p>
                :
