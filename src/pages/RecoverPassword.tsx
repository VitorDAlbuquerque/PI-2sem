...
export function RecoverPassowrd() {
  ...
  function confirmCode(e: FormEvent){
    ...
    if(code == String(emailCode)){
      ...
      toast.error('O código de verificação está inválido. Por favor, cheque seu email.')
    }
  }
      ...
      <div className="absolute top-0 left-0 w-full bg-gradient-to-l from-mainBg from-30% to-mainBgOpacity75 dark:bg-black ">
        ...
        <div className="flex h-90vh ">
          ...
          <div className="flex-1 flex justify-center items-center ">
            <div className="bg-bgAside h-420px w-96 rounded-lg p-5 flex items-center flex-col dark:bg-black ">
              ...
              {page == 1?
                <div className="flex flex-col gap-5 w-11/12 mt-5 justify-center">
                  <p className="text-bgWathcList text-center dark:text-white">Use seu email e recupere sua conta!</p>
              ...
              :page==2?
                <div className="flex flex-col gap-5 w-11/12 mt-5 justify-center">
                  <p className="text-bgWathcList text-center dark:text-white">Quase lá, confirme o código de segurança no seu email.</p>
                
                  <form onSubmit={confirmCode} className="flex flex-col gap-5 w-full justify-center">
                    <div>
                      <p className="text-bgWathcList dark:text-white">Código de segurança:</p>
                      <input
                          name="username"
                          className="w-full h-10 rounded-sm outline-none pl-3 dark:text-black"
                          type="text"
                    ...
                    <p onClick={()=>setPage(1)} className="text-bgWathcList hover:underline cursor-pointer text-center dark:text-white">Voltar</p>
              ...
              :page==3?
                <form onSubmit={updatePassword} className="flex flex-col gap-5  w-11/12 mt-5 justify-center">
                  <div>
                      <p className="text-bgWathcList dark:text-white">Nova senha:</p>
                      <input
                        name="username"
                        className="w-full h-10 rounded-sm outline-none pl-3 dark:text-black"
                        type="password"
                  ...
                  <div>
                    <p className="text-bgWathcList dark:text-white">Confirme a nova senha:</p>
                    <input
                      name="username"
                      className="w-full h-10 rounded-sm outline-none pl-3 dark:text-black"
                      type="password"
