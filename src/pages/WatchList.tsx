...
">
                    ...
                    <div className="mt-10 bg-bgAside p-10 dark:bg-black">
                        ...
                        {authContext.user?
                            <div className="flex items-center mb-12 gap-4">
                                ...
                                <form onSubmit={newComment} className="w-full flex gap-3">
                                    <input name="text" value={commentText} onChange={(e)=>setCommentText(e.target.value)} className="px-3 h-10 w-2/4 rounded-sm outline-none border-2 border-slate-400 bg-slate-900 text-slate-400 focus:border-constrastColor transition-all duration-200 
